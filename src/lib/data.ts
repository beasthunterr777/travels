...
export const bookingLinks: BookingLink[] = [
  ...
  },
  {
    ...
    provider: 'IRCTC',
    description: 'Official site for Indian Railways train bookings.',
    imageUrl: 'https://placehold.co/400x200.png',
    dataAiHint: 'train ticket booking',
  },
  {
    id: 'redbus',
    type: 'transport',
    ...
    provider: 'RedBus',
    description: 'Popular platform for booking inter-city bus tickets from various operators.',
    imageUrl: 'https://placehold.co/400x200.png',
    dataAiHint: 'bus booking platform',
  },
  {
    id: 'goibibo-hotels',
    type: 'accommodation',
