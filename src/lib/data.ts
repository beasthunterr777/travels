...
export const bookingLinks: BookingLink[] = [
  ...
  },
  {
    ...
    provider: 'Goibibo',
    description: 'Find deals on hotels and homestays.',
    imageUrl: 'https://placehold.co/600x400.png',
  ...
  },
  {
    ...
    provider: 'Agoda',
    description: 'Book hotels, resorts, and homes.',
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/17/Agoda_logo_2019.svg/320px-Agoda_logo_2019.svg.png',
    dataAiHint: 'agoda travel booking'
  },
  {
    id: 'ksrtc-booking',
    type: 'transport',
    ...
    provider: 'KSRTC',
    description: 'Official site for Karnataka state bus transport.',
    imageUrl: 'https://placehold.co/600x400.png',
    dataAiHint: 'bus transport karnataka'
  },
  {
    id: 'irctc-trains',
    type: 'transport',
    ...
    imageUrl: 'https://placehold.co/600x400.png',
    dataAiHint: 'train tickets india'
  },
  {
    id: 'redbus',
    type: 'transport',
    name: 'RedBus Bus Tickets',
    url: 'https://www.redbus.in/',
    provider: 'RedBus',
    description: 'Popular platform for booking bus tickets.',
    imageUrl: 'https://placehold.co/600x400.png',
    dataAiHint: 'bus tickets'
  },
];
